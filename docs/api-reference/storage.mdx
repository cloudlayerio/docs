...
- In `v2` `useStorage: true` is the default.
- In `v1` `useStorage: false` is the default.
...
- [GET /storages:id](#get-storageid)
- [GET /storages](#get-storages)
- [DEL /storages:id](#del-storages)
...
<BaseUrlCodeBlock path="/storages" title="POST /storages" />
...
<BaseUrlCodeBlock
  path="/storages/123456ab-1234-abcd-1234-123abc12"
  title="GET /storages:id"
/>
...
<BaseUrlCodeBlock path="/storages" title="GET /storages" />
...
<BaseUrlCodeBlock path="/storages:id" title="DEL /storages:id" />
