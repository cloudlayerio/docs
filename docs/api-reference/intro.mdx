...
:::info
There are some important but slight differences between v1 and v2. In addition, some default behaviors have changed. If you are currently using v2, please read about the changes in the changelog before switching.
:::
